...
""" Copy and pasted buttons from row 1 to 2 """
...
btn_C = Button(main,padx=16,bd=8,fg="black",font=("arial",20,"bold"),text="c",command=buttonClear)
btn_C.grid(row=4,column=1)

btn_equal = Button(main,padx=16,bd=8,fg="black",font=("arial",20,"bold"),text="=",command=buttonEqual)
btn_equal.grid(row=4,column=2)

btn_slash = Button(main,padx=16,bd=8,fg="black",font=("arial",20,"bold"),text="/",command=lambda: buttonClick("/"))
btn_slash.grid(row=4,column=3)
